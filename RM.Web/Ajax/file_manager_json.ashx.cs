...
namespace RM.Web.Ajax
{
    ...
    public class file_manager_json : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
           ...
           // string aspxUrl = "http://" + context.Request.Url.Authority + Intek.Kernel.Utils.HttpReq.GetSiteUrl_Root();

            //根目录路径，相对路径
            String rootPath = "../FileData/attached/";

            String rootUrl = "/FileData/attached/";
            //图片扩展名
