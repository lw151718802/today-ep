...
{
    public partial class ZS_Message : PageBase
    {
        ...
        private void DataBindGrid()
        {
            ...
            DataTable dt = this.member_idao.GetZS_MsgPage(SqlWhere, IList_param, this.PageControl1.PageIndex, this.PageControl1.PageSize, ref count);
