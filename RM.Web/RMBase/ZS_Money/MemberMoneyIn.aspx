<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberMoneyIn.aspx.cs" Inherits="RM.Web.RMBase.ZS_Money.MemberMoneyIn" %>
...
<body>
 ...
 管理奖金--%>
           ...
           <td>结束日期:</td> <td><input type="text" id="txtETime" class="txt" runat="server" style="width: 110px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" /></td>
              收入类型：<select id="SelState" class="select" runat="server" style="width: 110px">
                <option value="-1" selected="selected">全部</option>
                <option value="1">充值</option>
                <option value="2">销售奖励</option>
                <option value="4">服务奖励</option>
                  <option value="9">管理奖金</option>
                  <option value="3">转入</option>
                <option value="5">固定收益</option>
                  <option value="6">浮动分红</option>
                <option value="7">运营分红</option>
                  <option value="8">福利分红</option>
                            </select>
