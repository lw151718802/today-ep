...
{
    public partial class MemberMoneyDraw : PageBase
    {
        ...
        private void DataBindGrid()
        {
            ...
            {
                SqlWhere.Append(" and DrawTime >= @Btime ");
            ...
            {
                SqlWhere.Append(" and DrawTime <= @Etime ");
                IList_param.Add(new SqlParam("@Etime", this.txtETime.Value.Trim() + " 23:59:59"));

            }
        
                SqlWhere.Append(" and DrawStatus = @DrawStatus ");
                IList_param.Add(new SqlParam("@DrawStatus", DrawStatus.Items[DrawStatus.SelectedIndex].Value));
           

            DataTable dt = this.member_idao.GetZS_UserDrawPage(SqlWhere, IList_param, this.PageControl1.PageIndex, this.PageControl1.PageSize, ref count);
