...
{
    public partial class MemberMoneyForze : PageBase
    {
        ...
        private void DataBindGrid()
        {
            ...
            DataTable dt = this.member_idao.GetZ_UserMoenyForzePage(SqlWhere, IList_param, this.PageControl1.PageIndex, this.PageControl1.PageSize, ref count);
