<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberMoneyCZ.aspx.cs" Inherits="RM.Web.RMBase.ZS_Money.MemberMoneyCZ" %>
...
<script src="/Themes/Scripts/FunctionJS.js" type="text/javascript"></script>
  ...
  <script type="text/javascript">
      ...
      function zc_click()
      {
          var url = "/RMBase/ZS_Money/MemberMoneyZCADD.aspx";
          top.openDialog(url, 'ZS_UserForm', '账号充值', 400, 140, 50, 50);
      }
