...
namespace RM.Web.User.Ajax
{
    ...
    /// GetUserPage 的摘要说明
    /// </summary>
    public class GetUserPage : HandleBase
    {
        ...
        public override void AjaxProcess(HttpContext context)
        {
            ...
            SqlWhere.Append(" and ParentUserID = @ParentUserID");
            IList_param.Add(new SqlParam("@ParentUserID", UserID));
            ...
            DataTable dt = user_idao.GetZS_UserPage(SqlWhere, IList_param, pageindex, pageSize, ref count);
