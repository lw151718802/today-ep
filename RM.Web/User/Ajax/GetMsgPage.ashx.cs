...
namespace RM.Web.User.Ajax
{
    ...
    /// GetUserPage 的摘要说明
    /// </summary>
    public class GetMsgPage : HandleBase
    {
        ...
        public override void AjaxProcess(HttpContext context)
        {
            ...
            var t = Convert.ToInt32(context.Request["t"]);
            ...
            SqlWhere.Append(" and MsgType = @MsgType");
            IList_param.Add(new SqlParam("@MsgType", 1));
            if (t == 0) { 
                SqlWhere.Append(" or Extend = @Extend");
                IList_param.Add(new SqlParam("@Extend", UserAccount));
            }
            ...
            DataTable dt = user_idao.GetZS_MsgPage(SqlWhere, IList_param, pageindex, pageSize, ref count);
