<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonSY.aspx.cs" Inherits="RM.Web.User.template.Center.PersonSY" %>
  ...
  <!--#include file="../_footer.html"-->
    ...
    <script>
        function loadhtml() {
            ...
            $(".page-container").load("html/PersonSY.html?t=" + Math.random(), function () {
                init();
            });
        }
        function init() {
       ...
       function loadInfo() {
        ...
        function bindInfo(a) {
            ...
            $.each(a.t1, function (i, v) {
                ...
                tableStr += "<td>￥" + moneyIntFormat(v.GDSY + v.FDFH) + "</td>";
