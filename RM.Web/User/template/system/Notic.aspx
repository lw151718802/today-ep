<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notic.aspx.cs" Inherits="RM.Web.User.template.system.Notic" %>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 消息 <span class="c-gray en">&gt;</span> 系统公告 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/javascript">
    ...
    function loadhtml() {
        $(".page-container").load("html/Notic.html", function () {
            init();
        });
    }
