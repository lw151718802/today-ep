    ...
    $(obj).find("[datacol=yes]").each(function () {
        if ($(this).attr("checkexpession") != undefined) {
            switch ($(this).attr("checkexpession")) {
                ...
                case "MaxStr":
                    {
                        if (!isMaxStr($(this).val(), $(this).attr("length"))) {
                            Validatemsg = $(this).attr("err") + "必须大于" + $(this).attr("length") + "位字符！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "PInt":
                    {
                        if (!isPInt($(this).val())) {
                            Validatemsg = $(this).attr("err") + "必须正整数！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
